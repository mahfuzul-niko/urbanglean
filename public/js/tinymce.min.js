...
!(function () {
  ...
  function br(e, t) {
    return (
      ...
      He((r = void 0 === e ? document : e.dom))
        ? ve.none()
        : ve.from(r.querySelector(n)).map(Et.fromDom)
    );
    var n, r;
  }
  function yr(e, t, n) {
  ...
  function Sr(m, g) {
    ...
    function t(e) {
      ...
      ue(h, n).each(function (e) {
        var t;
        0 == --e.count &&
          (delete h[n], (t = e.id), br(jt(v), "#" + t).each(In));
      });
    }
    void 0 === g && (g = {});
    var p = 0,
  ...
  function Lr(e) {
    return (
      _o(e) && (e = e.parentNode), ko(e) && e.hasAttribute("data-mce-caret")
    );
  }
  function Ir(e) {
  ...
  function Vr(e) {
    return (
      !Mo(e) && (Bo(e) ? !Po(e.parentNode) : Lo(e) || Oo(e) || Io(e) || Fo(e))
    );
  }
  function qr(e, t) {
    return (
        ...
        !1 ===
          ...
          Vn((i = e)) &&
            ...
            !1 ===
              ((n = i),
              (r = Et.fromDom(a)),
              vr(Et.fromDom(n), "pre,code", R(je, r)).isSome()))) ||
      (Hn((o = e)) &&
        "A" === o.nodeName &&
        !o.hasAttribute("href") &&
  ...
  function oo(i) {
    function e(e, t, n) {
      ...
      return (
        r
          ? (r = ni(r, /[, ]/, ni(r.toUpperCase(), /[, ]/)))
          : (r = ei[e]) || ((r = to(t, n)), (ei[e] = r)),
        r
      );
    }
    var t,
        ...
        for (
          ...
          if ((i = y.exec(w[t]))) {
            ...
            h || "@" !== c || ((h = d), (v = m)),
              ...
              x.test(c) ? ((a.pattern = T(c)), N.push(a)) : (S[c] = a);
          }
      }
    }
    function B(e) {
      ...
      e &&
        ...
        ri(eo(e, ","), function (e) {
          ...
          (l[i] = l[o]),
            ...
            S[i] ||
              ((t = S[o]),
              delete (t = oi({}, t)).removeEmptyAttrs,
    ...
    ri(
      ...
      i.valid_elements
        ...
        : (ri(m, function (e, t) {
          ...
          ri(
            eo("p h1 h2 h3 h4 h5 h6 th td pre div address caption li"),
            function (e) {
              S[e].paddEmpty = !0;
            }
          ),
          ...
          if (((i = this.events[a]), e)) {
            for (var u, s, c, l, f = e.split(" "), d = f.length; d--; )
              if ((l = i[(o = f[d])])) {
                ...
                (t && 0 !== l.length) ||
                  (delete i[o],
                  lo(n, l.fakeName || o, l.nativeHandler, l.capture));
              }
          } else
            ne(i, function (e, t) {
  ...
  try {
    ji.apply((Ui = Vi.call(Di.childNodes)), Di.childNodes),
      Ui[Di.childNodes.length].nodeType;
  } catch (e) {
    ji = {
      apply: Ui.length
        ? function (e, t) {
  ...
  var ca = function (e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : Di) !== Si && wi(t),
      (n = n || []),
      !e || "string" != typeof e)
    )
      return n;
    ...
    if (Ei && !r) {
      if ((o = ia.exec(e)))
        if ((a = o[1])) {
          ...
          if ((a = o[3]) && di.getElementsByClassName)
  ...
  function la() {
    ...
    function r(e, t) {
      return (
        n.push(e + " ") > mi.cacheLength && delete r[n.shift()],
        (r[e + " "] = t)
      );
    }
    return r;
  ...
  (di = ca.support = {}),
        ...
        return s !== Si && 9 === s.nodeType && s.documentElement
          ? ((Ni = (Si = s).documentElement),
            ...
            (mi.find.TAG = di.getElementsByTagName
              ? function (e, t) {
                  if (typeof t.getElementsByTagName != Mi)
    ...
    (ca.attr = function (e, t) {
      ...
      var n = mi.attrHandle[t.toLowerCase()],
        r =
          n && Fi.call(mi.attrHandle, t.toLowerCase()) ? n(e, t, !Ei) : void 0;
      return void 0 !== r
        ? r
        : di.attributes || !Ei
        ? e.getAttribute(t)
    ...
    (ca.uniqueSort = function (e) {
      var t,
        ...
        o = 0;
      if (
        ((xi = !di.detectDuplicates),
        (Ci = !di.sortStable && e.slice(0)),
        e.sort(Ii),
        xi)
      ) {
    ...
    ((mi = ca.selectors =
      {
        ...
        preFilter: {
          ATTR: function (e) {
            return (
              (e[1] = e[1].replace(sa, fi)),
              (e[3] = (e[3] || e[4] || e[5] || "").replace(sa, fi)),
              "~=" === e[2] && (e[3] = " " + e[3] + " "),
              e.slice(0, 4)
            );
          },
        ...
        filter: {
          ...
          PSEUDO: function (e, i) {
            var t,
              a =
                mi.pseudos[e] ||
                mi.setFilters[e.toLowerCase()] ||
                ca.error("unsupported pseudo: " + e);
            return a[Ri]
              ? a(i)
              : 1 < a.length
              ? ((t = [e, e, "", i]),
    ...
    (hi = ca.tokenize =
      function (e, t) {
        ...
        for (a = e, u = [], s = mi.preFilter; a; ) {
          for (i in ((n && !(r = Gi.exec(a))) ||
            (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
          (n = !1),
          (r = Ji.exec(a)) &&
            ((n = r.shift()),
            o.push({ value: n, type: r[0].replace(Yi, " ") }),
            (a = a.slice(n.length))),
          mi.filter))
      ...
      function (e, t) {
            ...
            ((i = (function e(t) {
              for (
                ...
                if ((n = mi.relative[t[s].type])) f = [va(ba(f), n)];
                  ...
                  if (
                    (n = mi.filter[t[s].type].apply(null, t[s].matches))[Ri]
                  ) {
        ...
        function a(e, t, n, r, o) {
          ...
          if (((s += c), b && c !== s)) {
            ...
            ji.apply(r, f),
              o && !e && 0 < f.length && 1 < s + v.length && ca.uniqueSort(r);
          }
      ...
      function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === l.length)) {
          if (
            ...
            9 === t.nodeType &&
            Ei &&
            mi.relative[i[1].type]
          ) {
            if (!(t = (mi.find.ID(a.matches[0].replace(sa, fi), t) || [])[0]))
              return n;
            c && (t = t.parentNode), (e = e.slice(i.shift().value.length));
          }
          for (
            o = ta.needsContext.test(e) ? 0 : i.length;
            o-- && ((a = i[o]), !mi.relative[(u = a.type)]);

          )
            if (
              (s = mi.find[u]) &&
              (r = s(
                a.matches[0].replace(sa, fi),
                (aa.test(i[0].type) && ga(t.parentNode)) || t
              ))
            ) {
              if ((i.splice(o, 1), !(e = r.length && ha(i))))
                return ji.apply(n, r), n;
              break;
            }
        }
        return (
          (c || vi(e, l))(r, t, !Ei, n, (aa.test(e) && ga(t.parentNode)) || t),
          n
        );
      }),
  ...
  function qa(e, t, n) {
    var r = [],
      o = e[t];
    for (
      "string" != typeof n && n instanceof Ya && (n = n[0]);
      o && 9 !== o.nodeType;
  ...
  (Ea.fn = Ea.prototype =
    {
      ...
      init: function (e, t) {
        ...
        if (xa(e)) {
          if (
            ...
            return Ya(t).find(e);
          if (n[1])
            for (r = wa(e, Va(t)).firstChild; r; )
              Da.call(o, r), (r = r.nextSibling);
          else {
      ...
      add: function (e, t) {
        ...
        if (!1 !== t)
          for (
            n = Ya.unique(this.toArray().concat(Ya.makeArray(e))),
        ...
        return (function (e, t, n) {
          ...
          if (((n = n || e), t)) {
            if (
              n === e &&
              t.getBoundingClientRect &&
              "static" === wn(Et.fromDom(e), "position")
            ) {
      ...
      var _,
        ...
        $ = {
          ...
          getOuterHTML: function (e) {
            ...
            return Hn(t)
              ? t.outerHTML
              : Ya("<div></div>").append(Ya(t).clone()).html();
          },
            ...
            e(
              ...
              function () {
                ...
                !e ||
                  (n &&
                    -1 === ("," + (n || "") + ",").indexOf("," + e + ",")) ||
                  ou.ScriptLoader.add(l[t] + "/langs/" + e + ".js");
              },
              "loaded"
            );
        },
  ...
  function yu(e, t) {
    return He((n = void 0 === e ? document : e.dom))
      ? []
      : A(n.querySelectorAll(t), Et.fromDom);
    var n;
  }
  function Cu(r, e) {
    function t(e, t) {
  ...
  function Ou(e, t) {
    ...
    return (
      e.bottom - n < t.top ||
      (!(e.top > t.bottom) && Tu(t.top - e.bottom, e, t))
    );
  }
  function Bu(e, t) {
    return (
      e.top > t.bottom || (!(e.bottom < t.top) && Tu(t.bottom - e.top, e, t))
    );
  }
  function Pu(e, t, n) {
          ...
          (function (e) {
            ...
            function t(e, t) {
              ...
              if (t < e.data.length) {
                ...
                if (
                  Mu(e.data[t - 1]) &&
                  (n.setStart(e, t), n.setEnd(e, t + 1), !Hu(n))
                )
                  return r(Vu(ss(n), !1)), o;
              }
              0 < t &&
                (n.setStart(e, t - 1),
                n.setEnd(e, t),
            ...
            if (Qu(n))
              if (e.isAtEnd()) {
                var a = us(n, i);
                os(a) && t(a, a.data.length),
                  ns(a) && !is(a) && r(Vu(ss(a), !1));
              } else {
                if (((a = us(n, i)), os(a) && t(a, 0), ns(a) && e.isAtEnd()))
                  return r(Vu(ss(a), !1)), o;
                var u = us(e.container(), e.offset() - 1);
                ns(u) &&
                  !is(u) &&
                  ((!es(u) && !es(a) && ns(a)) || r(Vu(ss(u), !1))),
                  ns(a) && r(Vu(ss(a), !0));
              }
            return o;
          })(cs(t, n)));
  ...
  function Cs(e, t) {
    ...
    return Hn(e) && ((e = Iu(e, t)), pc(e))
      ? e
      : Mr(e)
      ? ((n = (e = Vn(e) && Lr(e) ? e.parentNode : e).previousSibling),
        pc(n) ? n : ((n = e.nextSibling), pc(n) ? n : void 0))
      : void 0;
  }
  function xs(e, t, n) {
    var r = n.getNode(),
    ...
    var a,
      ...
      d,
      m =
        Cs((a = i).startContainer, a.startOffset) ||
        Cs(a.endContainer, a.endOffset);
    return m
  ...
  function Ws(e, i, a, u) {
    ...
    return {
      show: function (e, t) {
        ...
        var r = $s(i, t, e);
        Ya(l).css("top", r.top);
        var o = Ya('<div class="mce-visual-caret" data-mce-bogus="all"></div>')
          .css(_e({}, r))
          .appendTo(i)[0];
        return (
          ...
          (c = Ar.setInterval(function () {
            u()
              ? Ya("div.mce-visual-caret", i).toggleClass(
                  "mce-visual-caret-hidden"
                )
              : Ya("div.mce-visual-caret", i).addClass(
                  "mce-visual-caret-hidden"
                );
          }, 500)),
  ...
  function nc(e, t, n) {
    ...
    if (Vn(a)) {
      ...
      if (Ro(a) && u >= a.data.length - 1)
        return 1 === e && (r = i(a)) ? Bc(r) : n;
  ...
  var sc,
    ...
    yc = Vn,
    Cc = function (e) {
      bc(e) && Mr(e) && (Fr(e) ? e.removeAttribute("data-mce-caret") : Us(e)),
        yc(e) && (Hs(e), 0 === e.data.length && Us(e));
    },
    xc = dt().browser,
    wc = Gn,
    Sc = Qn,
  ...
  function Hc(o, i, a) {
    return Zl(o, i, a).bind(function (e) {
      return Qs(a, e, i) &&
        ...
        o
          ? !zc(t, n) &&
            (cs.isTextPosition((r = t)) || !Kn(r.getNode())) &&
            Uc(t) &&
            Fc(n)
          : !zc(n, t) && Fc(t) && Uc(n))
        ? Zl(o, i, e)
  ...
  function Kc(e, t, n) {
    return (
      ...
      qc(e, t) &&
      ((o = n),
      (i = (r = t).ownerDocument.createTextNode(So)),
      r.appendChild(i),
      o.setStart(i, 0),
      o.setEnd(i, 0),
      1)
      ...
      if (t) {
        if ($c(t))
          return (
            (d = t),
            (m = (f = g).createRng()),
            Xc(f, !0, d, m) && Xc(f, !1, d, m) ? ve.some(m) : ve.none()
          );
        if (X(t.start))
          return ve.some(
            ((s = t),
        ...
        if (Ee(t, "id"))
          return dn(
            ...
            function (e, t) {
              var n = o.createRng();
              return (
                n.setStart(Wc(o, e.container()), e.offset()),
                n.setEnd(Wc(o, t.container()), t.offset()),
                n
              );
            }
          );
  ...
  function nl(e, t, n) {
    ...
    if (
      ...
      var a = i.childNodes,
        u = void 0;
      o < a.length
        ? ((i = a[o]), (u = new Dr(i, e.getParent(i, e.isBlock))))
        : ((i = a[a.length - 1]),
          (u = new Dr(i, e.getParent(i, e.isBlock))).next(!0));
  ...
  function kl(e, t, n, r) {
    ...
    return (
      ...
      Hn(a) &&
        a.hasChildNodes() &&
        ((a = Iu(a, t.collapsed ? u : u - 1)),
        Vn(a) && (u = a.nodeValue.length)),
      (o = vl(s, o)),
      (a = vl(s, a)),
      El(o) &&
        ((o = lf(o) ? o : o.parentNode),
        (o = t.collapsed ? o.previousSibling || o : o.nextSibling || o),
        Vn(o) && (i = t.collapsed ? o.length : 0)),
      El(a) &&
        ((a = lf(a) ? a : a.parentNode),
        (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a),
        Vn(a) && (u = t.collapsed ? 0 : a.length)),
      t.collapsed &&
      ...
      (pl(c) || c.block_expand) &&
        ((pl(c) && Vn(o) && 0 !== i) || (o = Nl(s, n, o, i, !0)),
        (pl(c) && Vn(a) && u !== a.nodeValue.length) ||
          (a = Nl(s, n, a, u, !1))),
      hl(c) &&
        ((o = wl(s, n, t, o, "previousSibling")),
        (a = wl(s, n, t, a, "nextSibling"))),
      (ml(c) || gl(c)) &&
        ((o = Sl(e, n, o, "previousSibling")),
        (a = Sl(e, n, a, "nextSibling")),
        ml(c) &&
          (s.isBlock(o) || (o = Nl(s, n, o, i, !0)),
          s.isBlock(a) || (a = Nl(s, n, a, u, !1)))),
  ...
  function Ol(o, e) {
    return dn(
      ...
      Vn(r)
        ? 0 === i
          ? ve.some(Et.fromDom(r))
          : ve.none()
        : ve.from(r.childNodes[i]).map(Et.fromDom)),
      ((t = e.endContainer),
      (n = e.endOffset),
      Vn(t)
        ? n === t.data.length
          ? ve.some(Et.fromDom(t))
          : ve.none()
        : ve.from(t.childNodes[n - 1]).map(Et.fromDom)),
      function (e, t) {
        var n = M(pf(o), R(je, e)),
          r = M(hf(o), R(je, t));
  ...
  function Bl(e, t, n, r) {
    ...
    do {
      if (Vn(n) && 0 !== Nt.trim(n.nodeValue).length)
            ...
            (u = o).undoManager.transact(function () {
              ...
              i.collapsed &&
                ...
                o.getRng().collapsed && !a
                  ? (Su((r = Fl(u.getDoc(), l, s, c.decorate)), wo),
  ...
  ((cc = sc = sc || {})[(cc.Backwards = -1)] = "Backwards"),
    (cc[(cc.Forwards = 1)] = "Forwards");
  function jl(e) {
    return (
      Lo(e) ||
      (!!Fo((t = e)) &&
  ...
  var Vl,
    ...
    Ql = function (e, t, n) {
      ...
      if (t.isEqual(cs.after(n)) && n.lastChild) {
        if (
          ((i = cs.after(n.lastChild)),
          e < 0 && Gl(n.lastChild) && Xl(n.lastChild))
        )
          return Yl(n.lastChild) ? cs.before(n.lastChild) : i;
      } else i = t;
      var a,
        u,
        s,
      ...
      if (Kl(c)) {
        ...
        if (0 < e && l < c.childNodes.length && ((f = Lc(c, l)), Gl(f)))
          return Yl(f)
            ? ((a = n),
              (s = (u = f).nextSibling) && Gl(s)
                ? Kl(s)
                  ? cs(s, 0)
                  : cs.before(s)
                : Ql(sc.Forwards, cs.after(u), a))
            : !jl(f) && (o = Gs(f, e, Jl, f))
            ? Kl(o)
              ? cs(o, 0)
              : cs.before(o)
    ...
    cf = function (e, t) {
      return (
        void 0 === t && (t = !1),
        !(!V(e) || !Vn(e)) && $r(t ? e.data.replace(/ /g, "\xa0") : e.data)
      );
    },
    lf = Qc,
    ff = fl,
    ...
    gf = function (e, t, n, r) {
      var o = n.parentNode;
      return (
        !V(n[r]) && (!(o !== t && !K(o) && !e.isBlock(o)) || gf(e, t, o, r))
      );
    },
    pf = function (t) {
    ...
    function n(e) {
      ...
      !(function (e, t) {
        if ("longpress" !== e.type && 0 !== e.type.indexOf("touch"))
          return c(e.target) && !yf(e.clientX, e.clientY, t);
        var n = e.touches[0];
    ...
    function i(e) {
      ...
      return (
        ...
        (T.hasClass(e, "mce-preview-object")
          ? ze(Et.fromDom(e.firstElementChild), t)
          : ze(Et.fromDom(e), t))
      );
    }
    function a(e, t, n) {
  ...
  function Rf(e, t, n) {
    for (
      var r = new Dr(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot());
      (t = r[n ? "prev" : "next"]());
  ...
  function Df(e, t, n, r, o) {
    ...
    if (r && Kn(o) && t && e.isEmpty(c))
      return ve.some(cs(o.parentNode, e.nodeIndex(o)));
    for (var l, f, d = new Dr(o, c); (a = d[r ? "prev" : "next"]()); ) {
      if (
        "false" === e.getContentEditableParent(a) ||
        ((f = u), Mr((l = a)) && !1 === _f(l, f, Vc))
      )
        return ve.none();
    ...
    return (
      t === r && Vn(t)
        ? 0 < n &&
          ...
          ((t = (r = Bf(t, n)).previousSibling),
          n < o
            ? ((t = r = Bf(r, (o -= n)).previousSibling),
        ...
        : (Vn(t) &&
          ...
          Vn(r) &&
            0 < o &&
            o < r.nodeValue.length &&
            (o = (r = Bf(r, o).previousSibling).nodeValue.length)),
  ...
  var If = {
    ...
    Mf = Gn;
  (Lf.compareRanges = kf),
    (Lf.getCaretRangeFromPoint = Ef),
    (Lf.getSelectedNode = Lu),
    (Lf.getNode = Iu);
  var Ff,
    Uf,
    zf =
      ...
      }),
      {
        set: function (e, t) {
          if (!N(t) && !t.match(/^[0-9]+$/))
            throw new Error(
              Ff + ".set accepts only positive integer values. Value was " + t
            );
          var n = e.dom;
  ...
  function od(e) {
    return (
      ...
      ve.from(e.dom.activeElement).map(Et.fromDom)
    );
  }
  function id(e, t) {
  ...
  function ad(e) {
    return Id.range(
      e.start,
      id(e.soffset, e.start),
      e.finish,
      id(e.foffset, e.finish)
    );
  }
  function ud(e, t) {
  ...
  function vd(e, t) {
    e.focusedEditor === t.editor && (e.focusedEditor = null),
      e.activeEditor || (Ud.unbind(document, "focusin", Ad), (Ad = null));
  }
  function bd(t, e) {
    var n, r;
    (n = Et.fromDom(t.getBody())),
      ((r = e).collapsed
        ? ve.from(Iu(r.startContainer, r.startOffset)).map(Et.fromDom)
        : ve.none()
      )
        .bind(function (e) {
        ...
        if (r)
          do {
            ...
            if (
              ...
              return !1;
            if (3 === r.type && r.parent && t[r.parent.name] && $r(r.value))
              return !1;
            if (n && n(r)) return !1;
          } while ((r = kd(r, this)));
        return !0;
  ...
  function dm(e) {
    ...
    return (
      Vn(t) &&
      (0 === t.data.length || (No(t.data) && Hl.isBookmarkNode(t.parentNode)))
    );
  }
  function mm(t, n) {
    return function (e) {
  ...
  function pm(e) {
    return (
      Gn(e) && !(Hn((t = e)) && "all" === t.getAttribute("data-mce-bogus"))
    );
    var t;
  }
  function hm(e) {
  ...
  function _m(e, t) {
    return (
      ve.from(t.getNode(!0)).map(Et.fromDom).exists(Pr) || Em(!1, e, t).isSome()
    );
  }
  function Am(e) {
  ...
  function Lm(e, t) {
    return (
      ...
      Pm(
        ...
        ((r = (n = t).container()),
        (o = n.offset()),
        Vn(r) && o < r.data.length ? cs(r, o + 1) : n)
      )
    );
    var n, r, o;
  }
  ...
  function qm(e, t) {
    return (
      ...
      (o = (n = t).container()),
      (i = n.offset()),
      !1 === cs.isTextPosition(n) &&
      o === r.parentNode &&
      i > cs.before(r).offset()
        ? cs(t.container(), t.offset() - 1)
        : t
    );
    var n, r, o, i;
  }
  function $m(e) {
    return Vr(e.previousSibling)
      ? ve.some(
          ((t = e.previousSibling), Vn(t) ? cs(t, t.data.length) : cs.after(t))
        )
      : e.previousSibling
  ...
  function Wm(e) {
    return Vr(e.nextSibling)
      ? ve.some(((t = e.nextSibling), Vn(t) ? cs(t, 0) : cs.before(t)))
      : e.nextSibling
      ? rf(e.nextSibling)
      : ve.none();
    var t;
          ...
          .bind(function (e) {
            var t,
              ...
              a =
                ...
                ve.from(s.dom.getParent(t, s.dom.isBlock)).map(Et.fromDom));
            o.deleteContents(),
              (n = s),
              (r = i),
            ...
            return (
              fg(s, u, l, i),
              Kr(u) ? ve.none() : ve.some(i ? c.slice(1) : c.slice(0, -1))
            );
          })
          .getOr(c)
      ),
      ...
      r &&
        (r.isEmpty(o) ||
          ...
          n.getBlockElements()[i.name] &&
            ...
            ("br" === (a = i.firstChild).name || a.value === wo))) &&
        (s = s.prev),
  ...
  function kg(e, t, n) {
    ...
    /^ | $/.test(t) &&
      ...
      (o = u.getRng()),
      (i = t),
      (i = Bm((a = Et.fromDom(r.getRoot())), cs.fromRangeStart(o))
        ? i.replace(/^ /, "&nbsp;")
        : i.replace(/^&nbsp;/, " ")),
      (t = i =
        Pm(a, cs.fromRangeEnd(o))
          ? i.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;")
          : i.replace(/&nbsp;(<br( \/)?>)?$/, " ")));
    var c = e.parser,
      l = n.merge,
    ...
    if (m.isDefaultPrevented())
      ...
      (t = m.content),
        -1 === (t = n.preserve_zwsp ? t : Eo(t)).indexOf("{$caret}") &&
          (t += "{$caret}"),
        (t = t.replace(/\{\$caret\}/, d));
      var g,
        p,
          ...
          if (e) {
            ...
            Vn(s)
              ? (u.setStart(s, s.nodeValue.length),
                xt.ie ||
                  ((a = e.nextSibling),
                  Vn(a) && (s.appendData(a.data), a.parentNode.removeChild(a))))
      ...
      ve.from(u.getBody()).fold(J(s), function (e) {
        return _g(s)
          ? (function (e, t, n, r) {
              ...
              return (
                (r.content = Eo(Co(Et.fromDom(t)) ? s : Nt.trim(s))),
          ...
          : ((t = u),
            ...
            0 === (r = Eo((r = s))).length || /^\s+$/.test(r)
              ? ((i = '<br data-mce-bogus="1">'),
                ...
                t.fire("SetContent", o))
              : ("raw" !== o.format &&
                  (r = rm({ validate: t.validate }, t.schema).serialize(
    ...
    if (a)
      if (b(a.length)) {
        ...
        for (var f = 0; f < a.length; f++)
          if ("attributes" === r ? e.getAttrib(t, a[f]) : cl(e, t, a[f]))
            return 1;
    return 1;
  }
  ...
  function $g(e, t, n, r) {
    ...
    for (
      3 === S.nodeType &&
      (N !== S.nodeValue.length && (o = !0), (E = E.parentNode));
      E;
    ...
    i &&
      (o
        ? ((a = C.getBookmark()),
          w.collapse(!0),
          (u = Pf(kl(e, w, e.formatter.get(t), !0))),
          e.formatter.remove(t, n, u, r),
          C.moveToBookmark(a))
        : ((s = qc(e.getBody(), i)),
          (d = c = Ug(!1).dom),
          (p = (g = e.dom).getParent((m = null !== s ? s : i), R(ol, e))) &&
          g.isEmpty(p)
  ...
  function Mp(e, r, o, t, i) {
    ...
    if (
      !(
        (pl((a = r)) && Rh(c, a.inline)) ||
        (ml(a) && Rh(c, a.block)) ||
        (gl(a) && Hn(c) && s.is(c, a.selector)) ||
    ...
    if ("all" !== r.remove) {
      Ah(r.styles, function (e, t) {
        (e = sl(u, al(e, o), t + "")),
          N(t) && ((t = e), (i = null)),
          (!r.remove_similar && i && !Rh(cl(u, i, t), e)) ||
            u.setStyle(b, t, ""),
          (n = !0);
      }),
        n &&
    ...
    return "none" !== r.remove
      ? ((l = e),
        ...
        (gl((g = d)) && pl(g) && fn(ue(g, "mixed"), !0) && !Rh(d.inline, f)) ||
          h.remove(f, !0),
        kh.removed())
      : kh.keep();
  }
      ...
      Y(l.split(","), function (t) {
        ...
        var n,
          r = ue(g, t).getOrThunk(function () {
            var e = {
              withSimilar: { state: au(!1), similar: !0, callbacks: [] },
              withoutSimilar: { state: au(!1), similar: !1, callbacks: [] },
              withVars: [],
            };
            return (g[t] = e);
          });
      ...
      undoManager: {
        ...
        add: function (e, t, n, r, o, i) {
          return (function (e, t, n, r, o, i, a) {
            var u = uh(e);
            if (((i = Nt.extend((i = i || {}), u)), !1 === dh(r) || e.removed))
              return null;
            var s = t.data[n.get()];
            if (
              e
      ...
      formatter: {
        ...
        canApply: function (u) {
          return (function (e) {
            ...
            if (t)
              for (
                var r = fl(n, e.selection.getStart()), o = t.length - 1;
                0 <= o;
                o--
              ) {
                var i = t[o];
                ...
                function (e) {
                  return (
                    ...
                    (f =
                      "raw" === l.format
                        ? Nt.trim(
                            Eo(em(r, t.serializer.getTempAttrs()).innerHTML)
                          )
                        : "text" === l.format
                        ? t.dom.isEmpty(r)
                          ? ""
                        ...
                        : ((a = (i = t).serializer.serialize(r, l)),
                          ...
                          a.replace(s, ""))),
                    T(["text", "tree"], l.format) || Co(Et.fromDom(r))
                      ? (l.content = f)
                      : (l.content = Nt.trim(f)),
      ...
      return t
        ...
        .map(function (e) {
          ...
          Ot((n = e)).each(function (e) {
            ...
            r && Bm(e, cs(t, 0))
              ? Hm(t, 0)
              : !r && Pm(e, cs(t, t.length)) && jm(t, t.length);
          });
        });
    });
  }
              ...
              ? (pl(A) || (ml(A) && A.wrapper)) &&
                ...
                (i = A).styles &&
                  ...
                  Eh(
                    a,
                    Rp(x, "fontSize"),
                    Dp(x, "backgroundColor", al(i.styles.backgroundColor, E))
                  ),
                (m = x),
                (p = e),
                (g = A).styles &&
                  (g.styles.color || g.styles.textDecoration) &&
                  (Nt.walk(p, C, "childNodes"), C(p)),
                (t = x),
                (o = e),
                !pl((r = A)) ||
                  ("sub" !== r.inline && "sup" !== r.inline) ||
                  (Eh(o, Rp(t, "fontSize"), Dp(t, "fontSize", "")),
                  t.remove(
  ...
  function Mh(e) {
    return (
      e && e.ownerDocument && Ve(Et.fromDom(e.ownerDocument), Et.fromDom(e))
    );
  }
  function Fh(a, u, e, s) {
    function t(e, t) {
    ...
    var l,
      ...
      v = {
        ...
        getNode: function () {
          return (function (e, t) {
            ...
            return !t.collapsed &&
              ...
              3 === n.nodeType &&
                3 === r.nodeType &&
                ((n = n.length === o ? Nd(n.nextSibling, !0) : n.parentNode),
                (r = 0 === i ? Nd(r.previousSibling, !1) : r.parentNode),
                n && n === r))
              ? n
              : a && 3 === a.nodeType
              ? a.parentNode
        ...
        getSelectedBlocks: function (e, t) {
          return (function (e, t, n, r) {
            ...
            if (
              ...
              for (var a, u = new Dr(n, i); (a = u.next()) && a !== r; )
        ...
        getBoundingClientRect: function () {
          var e = p();
          return e.collapsed
            ? cs.fromRangeStart(e).getClientRects()[0]
  ...
  function Wh(e, t, n, r) {
    (e.padd_empty_with_br || t.insert) && n[r.name]
      ...
      : (r.empty().append(new jd("#text", 3)).value = wo);
  }
  function Kh(n, e, t, r) {
          ...
          if (
            ...
            o &&
              ...
              Kh(h, m, g, i) &&
                ...
                (c.removeEmpty ? i.remove() : c.paddEmpty && Wh(p, n, d, i)));
          } else {
            for (
              a = o;
            ...
            a === i &&
              ...
              (((l = new jd("#text", 3)).value = wo), o.replace(l));
          }
      }),
      ...
      (rv.isDomSafe = function (e, t, n) {
        ...
        return !(
          ...
          !(r = n).allow_html_data_urls &&
            (/^data:image\//i.test(o)
              ? (V((a = r.allow_svg_data_urls)) ? !a : !V(i) || !T(tv, i)) &&
      ...
      : ((n = 0 === e.indexOf("//")),
        ...
        /^[\w\-]*:?\/\//.test(e) ||
          ((r = this.settings.base_uri
            ...
            : new rv(document.location.href).directory),
          (e =
  ...
  function iv(q, $) {
    ...
    function n(s, e) {
      ...
      for (
        ...
        var j = t[0];
        if ((w < t.index && R(E(x.substr(w, t.index - w))), (i = t[7])))
      ...
      for (w < x.length && R(E(x.substr(w))), r = S.length - 1; 0 <= r; r--)
  ...
  function cv(A, R) {
    ...
    var e = {
      ...
      parse: function (e, s) {
        ...
        var g = Tv(
            Av("script,style,head,html,body,title,meta,param"),
            R.getBlockElements()
          ),
          p = no(R),
                ...
                if (i) {
                  ...
                  (function () {
                    ...
                    ? g[l.name]
                      ...
                      : l.unwrap()
                    : i.paddEmpty &&
                      ((Gh((o = l), "#text") && o.firstChild.value === wo) ||
                        a) &&
                      Wh(A, s, g, l),
                    (l = u);
                }
    ...
    var o,
      ...
      h =
        ((i =
          ...
          (0,
          (f = (l = u).sections()),
          vv(l, "mobile") && "mobile" === f.mobile.theme)
            ? U(c, R(T, Hv))
            : a && vv(u, "mobile")
            ? c
            : s)),
        [].concat(hv(d)).concat(hv(i)));
      ...
      p = Nt.extend(
          ...
          : {},
        {
          ...
          external_plugins:
            ...
            u && u.external_plugins ? Nt.extend({}, u.external_plugins, s) : s),
        }
      );
    return yv(e, g, r, p);
  }
    ...
    function t(n, e) {
      if (
        ...
        !o.removed &&
          ...
          ve.from(r).map(Et.fromDom).map(Mn).getOr(!1)))
      )
        return (
  ...
  function ob(e) {
    return (
      e + ky++ + ("s" + new Date().getTime().toString(36) + t() + t() + t())
    );
    function t() {
                    ...
                    return (
                      ...
                      l.getParam("images_replace_blob_uris", !0, "boolean")
                        ...
                        : e.error &&
                          ...
                          Qv(
                            l,
                            lu.translate(["Failed to upload image: {0}", n])
                          )),
                      {
                        element: u,
                        status: e.status,
  ...
  function lb(e, t) {
    function m(e) {
      ...
      var t,
        ...
        r = n;
      return (
        (t = o).classes.length && Ay.addClass(r, t.classes.join(" ")),
        Ay.setAttribs(r, t.attrs),
        n
      );
    }
    var n,
    ...
    return e && e.length
      ? ((n = m((o = e[0]))),
        (r = Ay.create("div")).appendChild(p(n, e.slice(1), o.siblings)),
        r)
      : "";
  }
  function fb(e) {
    ...
    var s,
      ...
      l =
        (s = e.selector) && "string" == typeof s
          ...
          : [],
      f = l.length
        ? (l[0].name || (l[0].name = c), (c = e.selector), lb(l, n))
        : lb([c], n),
      ...
      (i = c).on("mouseup keydown", function (e) {
        ...
        Hg(t, null, !1),
          (8 !== n && 46 !== n) ||
            ...
            Hg(t, qc(o, r.getStart())),
          (37 !== n && 39 !== n) || Hg(t, qc(o, r.getStart()));
      }),
      {
        get: a.get,
        has: a.has,
    ...
    return (
      ...
      !Pb((u = i), (s = a).startContainer) && !Pb(u, s.endContainer) && c && l
        ...
        : ((n = f),
          ...
          (o = r.getRng()),
          dn(
            wb(n, Et.fromDom(o.startContainer)),
            wb(n, Et.fromDom(o.endContainer)),
            function (e, t) {
              return (
                !1 === je(e, t) &&
                (o.deleteContents(),
          ...
          (!1 === c && op(f)
            ...
            : ((r = s),
              ...
              Hn(a) && a.getAttribute("data-mce-caret") === u
                ? ((n = o.getNode(!1 === (t = e))),
                  (t && Gn(n.nextSibling)
                    ? ve.some(Iy.moveToElement(n.nextSibling))
                    : !1 === t && Gn(n.previousSibling)
                    ? ve.some(Iy.moveToElement(n.previousSibling))
                    : ve.none()
                  ).fold(function () {
                    return $b(r, e, o);
                  }, ve.some))
  ...
  function Xb(e, t) {
    ...
    return (
      ...
      Wb(e, n.parentNode)
        ...
        .fold(function () {
          return (
            Y(yu(Et.fromDom(e.getBody()), ".mce-offscreen-selection"), In),
            Qm(e, t, Et.fromDom(e.selection.getNode())),
            Sb(e),
            !0
          );
        }, w)
  ...
  function ty(e, t) {
    return (
      e
        ? function (e) {
            if (My(e.previousSibling))
              return (
                Zb(e.previousSibling) || e.previousSibling.appendData(So),
                e.previousSibling
              );
        ...
        : function (e) {
            if (My(e.nextSibling))
              return (
                Qb(e.nextSibling) || e.nextSibling.insertData(0, So),
                e.nextSibling
              );
  ...
  function my(e) {
    return (
      !1 ===
      ((t = Hy(e)),
      "rtl" === eu.DOM.getStyle(t, "direction", !0) ||
        ((n = t.textContent), Ty.test(n)))
    );
    var t, n;
  }
  function gy(e, t, n) {
  ...
  function Cy(e, t) {
    return e
      ? t.fold(i(ve.some, zy.start), ve.none, i(ve.some, zy.after), ve.none)
      : t.fold(ve.none, i(ve.some, zy.before), ve.none, i(ve.some, zy.end));
  }
  function xy(e, a, u, s) {
    var t = Cb(e, s),
      c = gy(a, u, t);
  ...
  function jy(e, t, n) {
    var r = e ? 1 : -1;
    return (
      t.setRng(cs(n.container(), n.offset() + r).toRange()),
    ...
    for (var o, i, a, u, s = Mc(n), c = r, l = []; c; ) {
      ...
      if (Kn(f.getNode(!1)))
        return t === sc.Forwards
          ...
          : { positions: Vy(t, l), breakType: Sy.Br, breakAt: ve.some(f) };
      if (f.isVisible()) {
        if (e(c, f)) {
          var d =
            ((o = c),
            Kn((i = f).getNode(t === sc.Forwards))
              ? Sy.Br
              : !1 === Qs(o, i)
              ? Sy.Block
              : Sy.Wrap);
    ...
    if (
      ...
      (a = c0(
        (function (e, r, t) {
          ...
          return (
            o.push(r),
            l0(Gy.Up, e, R(n, Ou), r.node, t),
            l0(Gy.Down, e, R(n, Bu), r.node, t),
            o
          );
        })(e, a, r(a)),
        t,
    ...
    if ((c = r(a) ? a.getNode() : o(a) ? a.getNode(!0) : Lu(n))) {
      var p = (function (e, t, n, r) {
          ...
          var i,
            ...
            f =
              1 === e
                ? ((i = s.next), (a = Bu), (u = Ou), cs.after(r))
                : ((i = s.prev), (a = Ou), (u = Bu), cs.before(r)),
            d = o(f);
          do {
            if (f.isVisible()) {
              var m = o(f);
      ...
      g.on("NodeChange", function (e) {
        ...
        !Ms(g) ||
          ...
          (l = g).selection.isCollapsed() &&
            !0 !== l.composing &&
            f.get() &&
            ((d = cs.fromRangeStart(l.selection.getRng())),
            cs.isTextPosition(d) &&
              !1 === (Ur((m = d)) || zr(m)) &&
              (v0(l, qs(f.get(), d)), f.set(null))),
          (n = h),
          (r = g),
          (o = p),
          (t = e.parents),
    ...
    if (e.selection.isCollapsed() && Ms(e)) {
      ...
      return (
        ...
        (f = gy(l, c, u))
          .bind(function (e) {
            return a
              ? e.fold(J(ve.some(vy(e))), ve.none, J(ve.some(hy(e))), ve.none)
              : e.fold(ve.none, J(ve.some(hy(e))), ve.none, J(ve.some(vy(e))));
          })
          .map(N0(i, o))
          .getOrThunk(function () {
            var t = Hc(a, c, u),
    ...
    e.queryCommandState("InsertUnorderedList") ||
      ...
      Y(o1(e), function (e) {
        var t,
          ...
          u = B0(d, Et.fromDom(a));
        "outdent" === r
          ? ((t = Math.max(0, O0(a.style[u]) - o)),
            n.setStyle(a, u, t ? t + i : ""))
          : ((t = O0(a.style[u]) + o + i), n.setStyle(a, u, t));
      });
  }
  function M0(e, t) {
            ...
            Vn((h = s)) || (Hn(h) && !z0(p, h) && !Qc(h))
              ? (function (e, t) {
                  if (Vn(t)) {
                    ...
                    if (
                      /^\s+$/.test(t.nodeValue) &&
                      (!t.nextSibling || z0(e, t.nextSibling))
                    )
                      return 1;
                  }
                })(u, s)
  ...
  function V0(e, t) {
    ...
    if (n)
      return "compositionstart" === t.type
        ? (t.preventDefault(), t.stopPropagation(), void j0(e, n))
        : void (Fr(n) && (j0(e, n), e.undoManager.add()));
  }
  function q0(e, t, n) {
    var r,
      o,
      ...
      .exists(function () {
        if (
          ...
          var e =
            ...
            (o = v),
            "" === (n = C)
              ? ((l = o), G0(t, (f = Et.fromTag("br")), l), Y0(f))
              : ((i = t),
                (a = o),
                (u = r),
                (s = Et.fromTag(n)),
  ...
  function iC(e, t, n) {
    ...
    return (i.breakType === Sy.Wrap && 0 === i.positions.length) ||
      (!Kn(n.getNode()) && i.breakType === Sy.Br && 1 === i.positions.length)
      ? ((r = e),
        (o = t),
  ...
  function uC(u, s, c) {
    var e,
      ...
      n =
        ((e = !!s),
        (t = c.getNode(e)),
        Hn(t) && "TABLE" === t.nodeName ? ve.some(t) : ve.none()),
      r = !1 === s;
    n.fold(
      function () {
  ...
  function xC(e, t, n) {
    return !1 === Vn(t)
      ? n
      : e
      ? 1 === n && t.data.charAt(n - 1) === So
        ? 0
        : n
      : n === t.data.length - 1 && t.data.charAt(n) === So
      ? t.data.length
      : n;
  }
  function wC(e, t) {
    ...
    F &&
      ...
      /^(LI|DT|DD)$/.test(C) && c.isEmpty(b)
        ? ((E = t),
          ...
          k !== N.getBody() &&
            ((D = (A = pC((R = k)) && pC(R.parentNode) ? "LI" : A)
              ? E(A)
              : I.create("BR")),
            vC(k, _, !0) && vC(k, _, !1)
              ? gC(k, "LI")
        ...
        : (p && b === a.getBody()) ||
          ...
          Lr(b)
            ...
            : ((S = (w = d).cloneRange()).setStart(
                w.startContainer,
                xC(!0, w.startContainer, w.startOffset)
              ),
              ...
              (function (e) {
                for (
                  ;
                  Vn(e) && (e.nodeValue = e.nodeValue.replace(/^[\r\n]+/, "")),
                    (e = e.firstChild);
      ...
      : (function (e, t) {
          ...
          "LI" !== d || m || (l = f),
            c &&
              ...
              !(function (e) {
                for (
                  var t, n = new Dr(c, l), r = e.getNonEmptyElements();
                  (t = n.next());
  ...
  function WC(e, t, n) {
    n && !e.get()
      ? t.on("NodeChange", qC, !0)
      : !n && e.get() && t.off("NodeChange", qC),
      e.set(n);
  }
  function KC(n, r) {
    var e = r.container(),
  ...
  function GC(e) {
    ...
    return (
      ...
      (c = e).on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = e),
          eC([{ keyCode: If.SPACEBAR, action: Z0(YC, c) }], t).each(function (
            e
          ) {
            t.preventDefault();
          }));
    ...
    function a(e) {
      ...
      e.isDefaultPrevented() ||
        ((t = e.dataTransfer) &&
          ...
          (e.preventDefault(),
          "drop" === e.type && Qv(i, "Dropped file type is not supported")));
    }
    function u(e) {
      pd(i, e.target) && a(e);
    }
      ...
      (n = e).on("drop", function (e) {
        var t =
          void 0 !== e.clientX
            ...
            : null;
        (!K1(t) && "false" !== n.dom.getContentEditableParent(t)) ||
          e.preventDefault();
      }),
  ...
  function E1(l) {
      ...
      if (s === u + 1 && a === e.endContainer) {
        ...
        if (f(c))
          return (function (e) {
            ...
            var r = (function (e, t, n) {
                ...
                t === n && xt.ie
                  ? (o
                    ...
                    i.setEndAfter(t))
                  : (o.empty().append(wo).append(t).append(wo),
            ...
            return (
              Y(
                yu(Et.fromDom(l.getBody()), "*[data-mce-selected]"),
                function (e) {
                  je(o, e) || Cn(e, S);
                }
              ),
    ...
    function h() {
      v && v.removeAttribute(S),
        br(Et.fromDom(l.getBody()), "#" + w).each(In),
        (v = null);
    }
    var v,
      n,
    ...
    return (
      xt.ceFalse &&
        ...
        l.on("click", function (e) {
          var t = N1(l, e.target);
          t &&
            (J1(t) && (e.preventDefault(), l.focus()),
            G1(t) && y.isChildOf(t, b.getNode()) && h());
        }),
        ...
        l.on(
          ...
          function (e) {
            var t = e.target,
              n = N1(l, t);
            J1(n)
              ? (e.preventDefault(), Fb(l, n).each(p))
              : f(t) && Fb(l, t).each(p);
          },
          !0
        ),
          ...
          (s !== x && "HTML" !== s.nodeName && !y.isChildOf(s, x)) ||
            ...
            ((t = N1(l, s))
              ? J1(t)
                ...
                : (h(),
                  (G1(t) && e.shiftKey) ||
                    yf(e.clientX, e.clientY, b.getRng()) ||
                    (N(), b.placeCaretAt(e.clientX, e.clientY)))
              : f(s)
              ? Fb(l, s).each(p)
              : !1 === Xs(s) &&
                (h(),
                    ...
                    ((r !== u && y.isChildOf(a, u) && !1 === J1(N1(l, a))) ||
                      (!y.isChildOf(u, a) &&
                        ...
                        (function (e) {
                          ...
                          if (!K(t)) {
                            var n = cs.before(t);
                            if (Kn(n.getNode()) && 1 === e.childNodes.length)
                              return !c(n);
                            var r = Mc(e).next(n);
                            return r && !c(r);
                          }
        ...
        (e = mu(function () {
          ...
          n.removed ||
            ...
            ((e = n.selection.getRng()).collapsed &&
              ((t = zb(n, e, !1)), n.selection.setRng(t)));
        }, 0)),
      ...
      a.inline ||
        b.bind(a.getDoc(), "mousedown mouseup", function (e) {
          ...
          e.target === a.getDoc().documentElement &&
            ...
            a.getBody().focus(),
            "mousedown" === e.type
              ? Mr(t.startContainer) || y.placeCaretAt(e.clientX, e.clientY)
              : y.setRng(t));
        });
    }
    function r() {
          ...
          xt.ie &&
            ...
            a.on("dragstart", function (e) {
              ...
              (t = e).dataTransfer &&
                ...
                0 < (n = a.selection.getContent()).length &&
                  ((r = N + escape(a.id) + "," + escape(n)),
                  t.dataTransfer.setData(E, r)));
            }),
            a.on("drop", function (e) {
              ...
              u(e) ||
                ((t =
                  e.dataTransfer &&
                  (o = e.dataTransfer.getData(E)) &&
                  0 <= o.indexOf(N)
                    ? ((o = o.substr(N.length).split(",")),
  ...
  function P1(t, e) {
    ...
    n.inline || (t.getElement().style.visibility = t.orgVisibility),
      ...
      t.inline &&
        (Q1.addClass(r, "mce-content-body"),
    ...
    (v.disabled = !0),
      ...
      t.readonly ||
        (t.inline &&
          "static" === Q1.getStyle(v, "position", !0) &&
      ...
      (t.parser =
        ((i = cv(R1((u = t)), u.schema)).addAttributeFilter(
    ...
    (k = _),
      ...
      (S = C.getParam(
        "placeholder",
        vc.getAttrib(C.getElement(), "placeholder"),
        "string"
      )),
      (N = function (e, t) {
        var n, r, o;
        !(function (e) {
          ...
          (r =
            !(
              hb((o = e)) &&
              !(vb(o) || ("keyup" === o.type && 229 === o.keyCode))
            ) &&
            (function (e, t, n) {
    ...
    (function (t) {
      ...
      t.fire("PreInit"),
        e.browser_spellcheck ||
          e.gecko_spellcheck ||
          ((n.body.spellcheck = !1), Q1.setAttrib(r, "spellcheck", "false")),
        (t.quirks = k1(t)),
        t.fire("PostRender");
  ...
  function F1(e) {
    ...
    return (
      ...
      X(Is(e))
        ...
        : y(Is(e))
        ? ((n = (t = e).getElement()),
          (r = Is(t)(t, n)).editorContainer.nodeType &&
        ...
        : ((u = (o = e).getElement()),
          o.inline
            ? M1(null)
            : ((i = u), (a = ex.create("div")), ex.insertAfter(a, i), M1(a)))
    );
  }
  function U1(e) {
    var n, t, r, o, i, a, u, s;
    e.fire("ScriptsLoaded"),
      ...
      (a = Is((o = e))),
      X(a)
        ? ((o.settings.theme = I1(a)),
          (i = Yv.get(a)),
          (o.theme = new i(o, Yv.urls[a])),
          o.theme.init &&
            o.theme.init(
              o,
              Yv.urls[a] || o.documentBaseUrl.replace(/\/$/, ""),
              o.$
            ))
        : (o.theme = {}),
      (s = []),
            ...
            function (e) {
              t.add(e.url, te, void 0, function () {
                Zv(
                  n,
                  "IconsLoadError",
                  eb("icons", e.url, e.name.getOrUndefined())
                );
              });
            }
          ),
    ...
    X(i)
      ? (z1(i) ||
          ...
          ((t = e.getParam("theme_url"))
            ? Yv.load(i, e.documentBaseURI.toAbsolute(t))
            : Yv.load(i, "themes/" + i + "/theme" + r + ".js")),
    ...
    tx = function (t, n, r) {
      ...
      if (
        ...
        try {
          ...
          (i = r),
            (a = e),
            Cf((o = t), "PluginLoadError", {
              message: (u = lu.translate([
      ...
      (lx.prototype.setupCommands = function (u) {
        ...
        this.addCommands({
              ...
              (r = u).removed ||
                (o
                  ...
                  : function (t) {
                      ...
                      t.inline || (xt.opera || yd(n), t.getWin().focus()),
                        (xt.gecko || t.inline) && (yd(n), bd(t, r)),
                        zd(t);
                    })(r);
          },
          ...
          FontSize: function (e, t, n) {
            var r;
            (r = u).formatter.toggle("fontsize", { value: W1(r, n) }),
              r.nodeChanged();
          },
        ...
        hu((r = e))
          ...
          : ((u = o),
            ...
            (s = U(pu((a = r), "class"), function (e) {
              ...
              ? pn(a, "class", s.join(" "))
              : Cn(a, "class")),
        0 === (hu((i = r)) ? i.dom.classList : pu(i, "class")).length &&
          Cn(i, "class"))
      : n && vu(e, t);
  }
  function dx(e, t, n) {
  ...
  function hx(t) {
    t.parser.addAttributeFilter("contenteditable", function (e) {
      px(t) &&
        Y(e, function (e) {
          e.attr(vx, e.attr("contenteditable")),
  ...
  function wx(e, t) {
    ...
    var n = Ls(e);
    return n
      ? (e.eventRoot || (e.eventRoot = Rx.select(n)[0]), e.eventRoot)
      : e.getBody();
  }
  function Sx(e, t, n) {
    var r, o, i, a;
  ...
  function Ex(e, t, n, r) {
    ...
    o.deactivate(),
      o.editorReadOnly !== i.editorReadOnly && gx(e, i.editorReadOnly),
      t.set(r),
    ...
    Ox(Bx(e.toLowerCase(), "+"), function (e) {
      e in Lx
        ...
        : ((n.charCode = e.charCodeAt(0)),
          (n.keyCode = Px[e] || e.toUpperCase().charCodeAt(0)));
    });
    var r = [n.keyCode];
  ...
  var _x,
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                (n.dom.unbind(wx(n, e), e, n.delegates[e]),
    ...
    Ix =
      ...
      (Mx.prototype.createShortcut = function (e, t, n, r) {
        ...
        return (
          (o[o.length - 1] = Nt.extend(o[o.length - 1], {
            func: n,
            scope: r || this.editor,
          })),
          Nt.extend(o[0], {
  ...
  var Fx = eu.DOM,
    ...
    Vx =
            ...
            ? t.getElement() &&
              ...
              (i = t.getElement().form || nx.getParent(e, "form")) &&
                ...
                t.getParam("hidden_input") &&
                  !jn(t.getElement()) &&
                  (nx.insertAfter(
                    nx.create("input", { type: "hidden", name: e }),
                    e
                  ),
                  (t.hasHiddenInput = !0)),
              ...
              "string" == typeof (s = l)
                ? Y(
                    ...
                    function (e) {
                      var t = e.split("=");
                      1 < t.length
                        ? (c[Nt.trim(t[0])] = Nt.trim(t[1]))
                        : (c[Nt.trim(t[0])] = Nt.trim(t[0]));
                    }
                  )
                : (c = s),
              c)
      ...
      (qx.prototype.show = function () {
        this.hidden &&
          ...
          this.inline
            ...
            : (Fx.show(this.getContainer()), Fx.hide(this.id)),
          this.load(),
          this.fire("show"));
      }),
      ...
      (qx.prototype.resetContent = function (e) {
        void 0 === e
          ? mv(this, this.startContent, { format: "raw" })
          : mv(this, e),
      ...
      (qx.prototype.getElement = function () {
        return (
          this.targetElm || (this.targetElm = Fx.get(this.id)), this.targetElm
        );
      }),
            ...
            (n || t.removed
              ? (n ||
                ...
                (o = (r = t).formElement) &&
                  ...
                  Ov.unbind(o, "submit reset", r.formEventDelegate)),
  ...
  function qx(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      this.settings.referrer_policy &&
        (ou.ScriptLoader._setReferrerPolicy(this.settings.referrer_policy),
      ...
      (this.id = e),
      this.setDirty(!1),
      (this.documentBaseURI = new nv(this.settings.document_base_url, {
  ...
  function Wx(e) {
    e !== ew &&
      (e
        ? Ya(window).on("resize scroll", $x)
        : Ya(window).off("resize scroll", $x),
      (ew = e));
  }
  function Kx(t) {
    var e = nw;
  ...
  var Xx,
    ...
    ow = _e(_e({}, Ax), {
      ...
      setup: function () {
        ...
        (this.baseURL = new nv(n).toAbsolute(e)),
          (this.documentBaseURL = n),
          (this.baseURI = new nv(this.baseURL)),
          (this.suffix = t),
              ...
              r.types
                ? Jx(r.types, function (t) {
                    Nt.each(o, function (e) {
                      return (
                        !Yx.is(e, t.selector) || (n(u(e), Qx({}, r, t), e), !1)
                      );
                    });
                  })
                : (Nt.each(o, function (e) {
      ...
      add: function (e) {
        ...
        return (
          tw[e.id] === e ||
            (null === n.get(e.id) &&
              ("length" !== e.id && (tw[e.id] = e), tw.push(e), nw.push(e)),
            Wx(!0),
            (n.activeEditor = e),
        ...
        if (e) {
          if (!X(e))
            return (
              ...
              l(r.get(n.id))
                ? null
                : (Kx(n) && r.fire("RemoveEditor", { editor: n }),
                  0 === nw.length &&
                    window.removeEventListener("beforeunload", Xx),
                  n.remove(),
                  Wx(0 < nw.length),
                  n)
            );
      ...
      _setBaseUrl: function (e) {
        (this.baseURL = new nv(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, "")
        )),
          (this.baseURI = new nv(this.baseURL));
      },
    ...
    Rw =
      ...
      (Dw.prototype.send = function (e) {
        ...
        (o.success = function (e, t) {
          (e =
            void 0 === (e = Ew.parse(e)) ? { error: "JSON Parse error." } : e)
            .error
