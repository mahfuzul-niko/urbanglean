...
@section('gtag')
    ...
    <script>
        gtag('event', 'conversion', {
            'send_to': 'AW-704674719/QvAPCOz4ve0aEJ_3gdAC',
            'value': {{optional($order)->total_payable}},
            'currency': 'BDT',
                ...
                <div class="col-lg-12">
                    <div class="account__wrapper account__wrapper--style4 border-radius-10">
                        <div class="account__content">
                            <div class="row">
                                <div class="col-md-8">
                                    <h2 class="account__content--title h3 mb-20 text-success ps-3">Your order has been placed successfully,  Thank you</h2>
                                </div>
