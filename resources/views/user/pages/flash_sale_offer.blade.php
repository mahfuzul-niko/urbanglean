...
<section class="deals__banner--section py-4">
    <div class="container-fluid">
        <div class="deals__banner--inner banner__bg rounded" 
        style="background: url({{asset('images/product/'.optional($flash_sale_offer)->image)}}) !important;">
            <div class="row row-cols-1 align-items-center">
                <div class="col">
                    <div class="deals__banner--content position__relative">
                        <h2 class="deals__banner--content__maintitle">
                            {{optional($flash_sale_offer)->title}}
                        </h2>
