        ...
        <div class="container-fluid">
            <div class="row mb-9">
                                                        ...
                                                        <div class="product__image two d-flex align-items-left">
                                                            ...
                                                            <div class="product__description">
                                                                ...
                                                                <p style="line-height: 1px !important;">
                                                                    {!! $variation_info !!}</p>
                                                                <span
                                                                    class="cart__price">৳{{ number_format(optional($cart->options)->new_price * $cart->qty, 2) }}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                ...
                <div class="col-lg-7 pr-lg-4 mb-4 p-3">
                    <form class="form checkout-form shadow rounded p-5" action="{{ route('order.create') }}"
                        method="post">
                        @csrf
                        @if (!Auth::check())
                            <div class="">
                            ...
                            <div class="col-md-6 mb-3 d-none ">
                                <div class="checkout__input--list checkout__input--select select">
                                    ...
                                    <select name="area_id" id="areas"
                                        class="checkout__input--select__field border-radius-5 @error('area_id') is-invalid @enderror">
