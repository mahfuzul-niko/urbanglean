    ...
    <div class="container-fluid">
            <div class="row mb-9">
                                            ...
                                            <td class="cart__table--body__list">
                                                <div class="product__image two d-flex align-items-left">
                                                    ...
                                                    <div class="product__description">
                                                        ...
                                                        <span class="cart__price">৳{{number_format((optional($cart->options)->new_price * $cart->qty), 2)}}</span>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                ...
                <div class="col-lg-7 pr-lg-4 mb-4 p-3">
                    <form class="form checkout-form shadow rounded p-5" action="{{ route('order.create') }}" method="post">
                        @csrf
                        @if(!Auth::check())
                        <div class="">
                    ...
                    <div class="row gutter-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td width="50%" class="form-group mb-3">
                                            <div class="checkout__checkbox">
                                                <input class="checkout__checkbox--input shipping_method" id="check{{$district->id}}" type="radio" name="district_id" value="{{ $district->id }}">
                                                <span class="checkout__checkbox--checkmark"></span>
                                                <label class="checkout__checkbox--label" for="check{{$district->id}}">
                                                    {{ optional($district)->name }}:
                                                    <strong>{{ optional($district)->shipping_charge }}<span>TK</span></strong></label>
                                            </div>
                                        </td>
                                        @endforeach
                        ...
                        <div class="col-md-6 mb-3 d-none ">
                            <div class="checkout__input--list checkout__input--select select">
                                ...
                                <option value="">Please Chose an Area dfdf</option>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="shipping_address" id="" cols="30" rows="20" style="height:6.5rem;" required placeholder="House number and street name" class="checkout__input--field border-radius-5 mb-2" >{{ optional(Auth::user())->address }}</textarea>
