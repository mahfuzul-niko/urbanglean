...
<section class="product__section section--padding pt-3" style="padding-bottom: 4rem !important;">
    <div class="container-fluid">
        <div class="section__heading mb-2 border-bottom">
            <div class="d-flex justify-content-between">
                <div class="text-center">
                    <img src="{{ asset('frontend/assets/flash-sale.gif') }}" width="100" height="" />
                    {{-- <h2 class="section__heading-- style2 flex-grow-1"></h2> --}}
                </div>
                ...
                <div class="btn_custom mb-2 ms-auto">
                    <a class="primary__btn rounded shop_more_btn" href="{{ route('flash.sale.offer.details', [optional($flash_sale_offer)->id, Str::slug(optional($flash_sale_offer)->title)]) }}">Shop More
            ...
            <div class="s_lg_none">
                <div class="deals__banner--countdown mb-2 ms-2 mt-2 d-flex"><div class="countdown__item" id="d_item"><span class="countdown__number" id="days">00</span></div><div class="countdown__item" id="h_item"><span class="countdown__number" id="hours">00</span></div><div class="countdown__item" id="m_item"><span class="countdown__number" id="minutes">00</span></div><div class="countdown__item" id="s_item"><span class="countdown__number" id="seconds">00</span></div></div>
            </div>
        </div>
        ...
        <div class="product__section--inner">
            <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
                ...
                @php( $product = App\Models\Product::where('id', $item->product_id)->first(['id', 'discount_type', 'discount_amount', 'type', 'title', 'thumbnail_image']) )
                    @if(!is_null($product))
