...
<head>
    ...
    <script>
        ...
        fbq('init', '747557351669601');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=747557351669601&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
</head>

<body>
    <div id="preloader" class="d-none"></div>
    @if (!empty($business->body))
        {!! $business->body !!}
    @endif
    <!-- Start header area -->
    ...
    <script>
        ...
        function search_product(type) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    if (type == 'd2') {
                        $('#search_product_output_d2').html(
                            '<div class="text-center col-md-12 p-4">Searching.....</div>');
                    } else {
                        $('#search_product_output_d1_main').show();
                        $('#search_product_output_d1').html(
                            '<div class="text-center col-md-12 p-4">Searching.....</div>');
                    }
                },
                success: function(data) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    $('#featured_products').html(
                        '<div class="col-md-12 mb-5 p-10 text-center"><h2>Loading...</h2>');
                },
                success: function(response) {
