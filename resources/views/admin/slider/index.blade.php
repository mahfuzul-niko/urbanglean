            ...
            <div class="card">
                <div class="card-header text-right">
                    <button type="button" class="btn btn-success btn-rounded" data-toggle="modal"
                        data-target="#exampleModal"><i class="fas fa-plus"></i> Create New Slider</button>
                </div>
                <!-- /.card-header -->
                            ...
                            @foreach ($sliders as $slider)
                                <tr>
                                    ...
                                    <td><img class="shadow rounded border p-1"
                                            src="{{ asset('images/slider/' . $slider->image) }}" width="100%"></td>
                                    <td>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Are tou sure you want to
                                                    delete ?</h5>
