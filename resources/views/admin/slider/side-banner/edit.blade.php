...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Edit Slider Side Banner</h1>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div>
...
<section class="content">
	<div class="container-fluid">
		<div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ route('slider_side_banner.update', optional($slider)->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          <label>Change Slider Side Banner Images (1140x488 px)</label>
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <img class="shadow rounded border p-2" src="{{ asset('images/slider/side-banner/'.optional($slider)->image ) }}" width="100%">
                        </div>
                      </div>
