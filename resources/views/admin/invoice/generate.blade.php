        ...
        <table>
            <tr>
                ...
                <th style="text-align: right; border: 0px solid white;">
                    <p class="invoiceIDandDate" style="font-family: Arial;">Invoice # {{ $order->code }}<br>Date:
                ...
                @foreach ($order->order_product as $product)
                    ...
                    <tr style="text-align: right;">
                        ...
                        <td style="text-align: right;">
                            <span>{{ env('CURRENCY') }}{{ $product->price * $product->qty }}</span>
            ...
            <tbody style="text-align: right;">
                ...
                @if ($order->coupon_discount_amount)
                    <tr style="text-align: right;">
                        ...
                        <td style="text-align: right;">
                            {{ env('CURRENCY') }}{{ $order->coupon_discount_amount }}
                        </td>
                    </tr>
                @endif
                ...
                <tr style="text-align: right;">
                    ...
                    <td style="text-align: right;">
                        {{ env('CURRENCY') }}{{ $order->delivery_charge == null ? 0 : $order->delivery_charge }}</td>
                </tr>
                ...
                <tr style="text-align: right;">
                    ...
                    <td style="text-align: right;">{{ env('CURRENCY') }}{{ $order->price + $order->delivery_charge }}
                    </td>
                </tr>
