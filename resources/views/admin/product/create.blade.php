						...
						<div class="col-md-8">
							<div class="row">
								...
								<div class="form-group col-md-6">
									...
									<div class="">
									<input type="text" name="unit_type" placeholder="Piece" value="{{ old('unit_type') }}" class="form-control @error('unit_type') is-invalid @enderror">
										@error('unit_type')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
								...
								<div class="form-group col-md-6">
									<label class="col-form-label"><b>Thumbnail 2 ( 600px X 600px )</b></label>
									<div class="">
									<input type="file" name="image2" class="form-control @error('image2') is-invalid @enderror" required>
										@error('image2')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
								...
								<div class="form-group col-md-6">
									<label class="col-form-label"><b>Gallery * ( 600px X 600px )</b></label>
									<div class="">
					...
					<div class="shadow p-2">
						<div class="form-group">
							...
							<label for="is_tranding" class="mr-3">
								<input type="checkbox" checked name="is_tranding" value="1" id="is_tranding">
								Tranding Product
							</label>

							<label for="todays_deal" class="mr-3 d-none">
								<input type="checkbox" checked name="todays_deal" value="1" id="todays_deal">
								Today's Deal
							</label>
				...
				<div class="col-md-12 my-3">
		      	<div id="single" class="shadow rounded p-2 border row" style="display:none;">
					...
					<div class="form-group col-md-6">
						...
						<input type="number" step="any" name="qty" value="{{ old('qty',100) }}" class="form-control @error('qty') is-invalid @enderror">
							@error('qty')
								<span class="invalid-feedback" role="alert">
									<strong>{{ $message }}</strong>
								</span>
				    ...
				    <div class="">
				    	<textarea class="form-control @error('feature') is-invalid @enderror" name="feature">
							<table class="table table-bordered " style="border-collapse: collapse; display:none; width: 100%;">
								<tbody>
								<tr>
								<td style="width: 50%;">Title 1</td>
								<td style="width: 50%;">&nbsp;</td>
								</tr>
								<tr>
								<td style="width: 50%;">Title 2</td>
								<td style="width: 50%;">&nbsp;</td>
								</tr>
								<tr>
								<td style="width: 50%;">Title 3</td>
								<td style="width: 50%;">&nbsp;</td>
								</tr>
								</tbody>
							</table>
