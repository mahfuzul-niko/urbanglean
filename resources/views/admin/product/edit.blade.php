                                    ...
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="">
                                                    <input type="text" name="unit_type" placeholder="Piece"
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            <label class=" col-form-label"><b>Thumbnail *( 600px X 600px
                                                                    )</b></label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            <label class=" col-form-label"><b>Thumbnail 2( 600px X 600px
                                                                    )</b></label>
                                                            ...
                                                            @enderror
                                                            <img src="{{ asset('images/product/' . $product->thumbnail_image2) }}"
                                                                class="shadow rounded mt-2 p-1" width="150px">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label"><b>Gallery *( 600px X 600px
                                                            )</b></label>
                                                    <div class="col-sm-10">
                                                ...
                                                <ul class="list-group list-group-unbordered p-2" id="">
                                                    @foreach ($categories as $category)
                                                        ...
                                                        $check_category = DB::table('product_with_categories')
                                                            ->where(['category_id' => $category->id, 'product_id' => $product->id])
                                                            ->first();
                                                        ?>
                                                        <li class="list-group-item itemss">
                                                            <label for="category_{{ $category->id }}"><input
                                                                    type="checkbox"
                                                                    @if (!is_null($check_category)) checked @endif
