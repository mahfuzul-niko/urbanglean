                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item d-none">
                                <a href="{{ route('allOrder') }}" class="nav-link">
                                    <i class="fas fa-angle-right"></i>
                                    <p>All Wholesale Orders <span
                                            class="badge badge-light ms-1">{{-- $wholesale_count --}}</span> </p>
                                </a>
                            </li>
                            @php
                            ...
                            @foreach ($order_status as $status)
                                ...
                                @endphp
                                <li class="nav-item">
                                    <a href="{{ route('order.status.filter', $status->order_status) }}"
                                        class="nav-link">
                                        <i class="fas fa-angle-right"></i>
                                        <p>{{ $status->order_status }} <span
                                                class="badge badge-light ms-1">{{ $count }}</span> </p>
                                    </a>
                                </li>
                            @endforeach
                            <li class="nav-item">
    ...
    $review_count = DB::table('products_reviews')->where(['is_active' => 0])->count('id')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('product.review.index') }}" class="nav-link">
                            ...
                            @if ($review_count > 0)
                                <span class="bg-primary px-2 p-1 rounded-pill text-light">{{ $review_count }}</span>
                            @endif
                        </a>
                    </li>
