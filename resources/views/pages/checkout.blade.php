                                    ...
                                    <table class="order-table">
                                        ...
                                        <tbody>
                                            @foreach ($carts as $cart)
                                                <tr class="bb-no">
                                                    ...
                                                    <td class="product-total">
                                                        {{ env('CURRENCY') }}{{ $cart->qty * $cart->price }}
                                                        {{ env('UAE_CURRENCY') }}</td>
                                                </tr>
                                            @endforeach
                                            <tr class="cart-subtotal bb-no">
                                                ...
                                                <td>
                                                    <b>{{ env('CURRENCY') }}{{ Cart::subtotal() - $discount }}
                                                        {{ env('UAE_CURRENCY') }}</b>
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <div class="payment-methods" id="payment_method">
                                        ...
                                        <div class="hidden" id="bkash">
                                            ...
                                            <input type="text" placeholder="Transaction Id"
                                                name="bkash_transaction_id" class="form-control">
                                            <input type="text" placeholder="Phone" name="bkash_phone"
                                                class="form-control">
                                            <input type="text" placeholder="Amount" name="bkash_amount"
                                                class="form-control">
                                        ...
                                        <div class="hidden" id="rocket">
                                            ...
                                            <input type="text" placeholder="Transaction Id"
                                                name="rocket_transaction_id" class="form-control" id="transaction_id">
                                            <input type="text" placeholder="Phone" name="rocket_phone"
                                                class="form-control">
                                            <input type="text" placeholder="Amount" name="rocket_amount"
                                                class="form-control">
                                        </div>
